...
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ seek(sf::Uint64\ sampleOffset)}
\DoxyCodeLine{\ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{comment}{//\ advance\ to\ the\ sampleOffset-\/th\ sample\ from\ the\ beginning\ of\ the\ sound}}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keyword}{virtual}\ sf::Uint64\ read(sf::Int16*\ samples,\ sf::Uint64\ maxCount)}
\DoxyCodeLine{\ \ \ \ \{}
...
{\footnotesize\ttfamily virtual Uint64 sf\+::\+Sound\+File\+Reader\+::read (\begin{DoxyParamCaption}\item[{Int16 \texorpdfstring{$\ast$}{*}}]{samples,  }\item[{Uint64}]{max\+Count }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [pure virtual]}}
...
\item 
C\+:/\+Users/\+Usuario/\+Documents/pruebas-\/c/\+Practica Animación/libraries/sfml-\/2.\+5.\+1/include/\+SFML/\+Audio/Sound\+File\+Reader.\+hpp\end{DoxyCompactItemize}
